...
Run the game, then run the program. EAC needs to be disabled for Elden Ring.
...
Cool, but something is probably still wrong with your PC. Check if anything looks weird in Device Manager, eg. if it's constantly refreshing.
